          ...
          <li class="search-list">
            <div class="search-input-wrapper">
              <div class="search-input">
                <form name="search-form" method="post" action="http://localhost/taskbook/list">
                  <input type="text" class="form-control input-sm inline-block" name="term">
                </form>
                <a href="javascript:document:search_form.submit();" class="input-icon text-normal"><i class="ion-ios7-search-strong"></i></a>
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul class="accordion">
          ...
          <li class="openable bg-palette3">
            ...
            <ul class="submenu bg-palette4">
                <li><a href="/page/taskbook/uploadTaskBook.jsp"><span class="submenu-label">上传任务书</span></a></li>
                <li><a href="http://localhost/taskbook/list?pageNumber=1&pageSize=10"><span class="submenu-label">查看任务书</span></a></li>
            </ul>
          </li>
  ...
  <div class="main-container">
    <div class="padding-md">
      <ul class="breadcrumb">
        ...
        <div>
        <form class="form-inline no-margin" action="http://localhost/taskbook/list" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="课程性质" id="courseProperty" name="courseProperty">
            </div><!-- /form-group -->
            <div class="form-group">
    ...
    <div>
      <ul class="pagination pagination-split">
        ...
        <li class="active"><a href="http://localhost/taskbook/list?pageNumber=1">1</a></li>
        <li><a href="http://localhost/taskbook/list?pageNumber=2">2</a></li>
        <li><a href="http://localhost/taskbook/list?pageNumber=3">3</a></li>
        <li><a href="http://localhost/taskbook/list?pageNumber=4">4</a></li>
        <li><a href="http://localhost/taskbook/list?pageNumber=5">5</a></li>
